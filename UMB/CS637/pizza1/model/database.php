...
if (gethostname() === 'topcat') {
    $username = 'mat9602';  // CHANGE THIS to your cs.umb.edu username
    $password = 'mat9602';  // CHANGE THIS to your mysql DB password on topcat 
    $dsn = 'mysql:host=localhost;dbname='. $username . 'db';
} else {  // dev machine, can create pizzadb
    $dsn = 'mysql:host=localhost;dbname=pizzadb';
    $username = 'mat9602';
    $password = 'mat9602';  // or your choice
}
